...
switch hemi
    case {'L','R'}
        [sample_roi_idx,roi_id] = sample2Benson(coords,surf_dir, brainmap_dir,hemi,dist_thr);
    case 'LR'
        
        [sample_roi_idx_L,roi_id_L] = sample2Benson(coords,surf_dir, brainmap_dir,'L',dist_thr);
        [sample_roi_idx_R,roi_id_R] = sample2Benson(coords, surf_dir,brainmap_dir,'R',dist_thr);
...
function [sample_roi_idx,roi_id] = sample2Benson(coords,surf_dir, brainmap_dir,hemi,dist_thr)
% surf file
...
[~,coords_roi,roi_id] = map_match_coords2surf(coords,surf_file,dist_thr,label_file);
