function  selVal = dwiRoiSelectivity(dwiDir, sessid, mapName, roiName)
% selVal = dwiRoiSelectivity(dwiDir, sessid, mapName, roiName)
...
for s = 1:nSubj
    sessDir = fullfile(dwiDir,sessid{s},'96dir_run1','bold');
